...
def _find_P(
    ...
    """
    return {
        'x': (r*(-n1*r - n2*m.sqrt(n1**2 - 2*n1*t1 + n2**2 - 2*n2*t2
                 - r**2 + t1**2 + t2**2) + r*t1 + t2*m.sqrt(n1**2
                 - 2*n1*t1 + n2**2 - 2*n2*t2 - r**2 + t1**2 + t2**2))
              / (n1**2 - 2*n1*t1 + n2**2 - 2*n2*t2 + t1**2 + t2**2)),
        'y': (-r*(r*(n2 - t2) - (n1 - t1)*m.sqrt(n1**2 - 2*n1*t1 + n2**2
                  - 2*n2*t2 - r**2 + t1**2 + t2**2))
              / (n1**2 - 2*n1*t1 + n2**2 - 2*n2*t2 + t1**2 + t2**2))}
